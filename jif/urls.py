...
from jif.views.edicao_views import (
    ...
    EdicaoUpdateView,
    EdicaoDeleteView,
    EdicaoEtapaCreateView,
    EdicaoEtapaUpdateView,
    EdicaoEtapaDeleteView,
    ...
    EdicaoModalidadeProvaUpdateView,
    EdicaoModalidadeProvaDeleteView
)
...
urlpatterns = [
    ...
    path('edicao/etapa/create/<pk>/', EdicaoEtapaCreateView.as_view()),
    path('edicao/etapa/<pk>/update', EdicaoEtapaUpdateView.as_view()),
    path('edicao/etapa/<pk>/delete/', EdicaoEtapaDeleteView.as_view()),
    ...
    path('edicao/prova/<pk>/update', EdicaoModalidadeProvaUpdateView.as_view()),
    path('edicao/prova/<pk>/delete', EdicaoModalidadeProvaDeleteView.as_view()),
    # Categoria URLs
